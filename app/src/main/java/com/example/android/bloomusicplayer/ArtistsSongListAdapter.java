...
public class ArtistsSongListAdapter extends RecyclerView.Adapter<ArtistsSongListAdapter.ViewHolder> {
    ...
    ArtistsSongListAdapter(ArrayList<Song> myDataset, RecyclerView recyclerView, Context context) {
    ...
    @NonNull
    @Override
    public ArtistsSongListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // create a new view
